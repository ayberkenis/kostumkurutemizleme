...
function Intro({  }) {
  ...
  return (
    <div className="w-full flex flex-row justify-center items-center h-full pt-12">
        <div className="intro-title text-2xl w-1/2 flex flex-col justify-center items-center">
            <h2 className="font-playfair font-bold text-2xl tracking-wider "><FontAwesomeIcon icon={faAddressBook}/> Bize Ulaşın</h2>
            <p className="font-poppins font-semibold text-black text-center p-4 text-lg">
                Türkali, Nüzhetiye Caddesi, No 16/A<br/>
                Beşiktaş/İstanbul<br/>
                +90 212 260 60 63<br/>

            </p>
            <h2 className="font-playfair font-bold text-2xl tracking-wider mt-4"><FontAwesomeIcon icon={faCalendarAlt}/> Çalışma Saatlerimiz:</h2>
            <p className="font-poppins font-semibold text-black text-center p-4 text-lg">
                Pazar hariç her gün / 08:00 - 19:30
            </p>

        </div>
            <div className="w-1/2 h-full max-w-full resize-none border-2 drop-shadow-xl shadow-2xl">
